class BatchNorm2d(Module):
  ...
  num_features : Final[int] = 512
  momentum : Final[float] = 0.10000000000000001
  def forward(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_24.BatchNorm2d,
    input: Tensor) -> Tensor:
    ...
    return _9
  def _check_input_dim(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_24.BatchNorm2d,
    input: Tensor) -> None:
