class Conv2d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_26.Conv2d,
    input: Tensor) -> Tensor:
    _0 = (self)._conv_forward(input, self.weight, )
    return _0
  def _conv_forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_26.Conv2d,
    input: Tensor,
