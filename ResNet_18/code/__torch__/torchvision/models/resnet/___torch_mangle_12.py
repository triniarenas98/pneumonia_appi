class BasicBlock(Module):
  ...
  downsample : __torch__.torch.nn.modules.container.___torch_mangle_11.Sequential
  def forward(self: __torch__.torchvision.models.resnet.___torch_mangle_12.BasicBlock,
    x: Tensor) -> Tensor:
